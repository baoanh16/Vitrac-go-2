...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
    ...
    <input type="hidden" id="hdfDealerLocatorSelectLocation">
    <xsl:attribute name="value">
      <xsl:value-of select="/DealerList/SelectLocationText"></xsl:value-of>
    </xsl:attribute>
    </input>
                    ...
                    <div class="search-location findmaps">
                        ...
                        <div class="filtermap">
                          ...
                          <div class="field form_desc">
                            <select class="form-select" id="ddlLocation">
                            </select>
                          </div>
                          <div class="field form_desc">
                            ...
                            <select class="form-select" id="ddlProvince" hidden="hidden">
                              <option value="">
                                <xsl:value-of select="/DealerList/SelectProvinceText"></xsl:value-of>
                              </option>
                            </select>
                          </div>
                          <div class="field form_desc" hidden="hidden">
                          ...
                          <input type="submit" id="edit-submit" class="btn-searchmap" hidden="hidden">
                          <xsl:attribute name="value">
                      ...
                      <div class="hidden-xs-up" hidden="hidden">
